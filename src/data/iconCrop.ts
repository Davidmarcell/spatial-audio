...
export const iconCropBySrc: Record<string, IconCrop> = {
  ...
  '/icons/waves-courbet-the-wave.jpg': { scale: 1.15, y: '54%' },
  '/icons/forest-otira-gorge-nz.jpg': { scale: 1.08, y: '46%' },
  ...
  '/icons/toucan-toco-gould.jpg': { scale: 1.18, y: '52%' },
  ...
  '/icons/insects.jpg': { scale: 1.12, y: '46%' },
  '/icons/cicada-maculata.jpg': { scale: 1.08, y: '50%' },
  '/icons/insect-jardine-plate.jpg': { scale: 1.1, y: '46%' },
  '/icons/insect-field-cricket-plate.jpg': { scale: 1.08, y: '48%' },
  '/icons/insect-natural-history.jpg': { scale: 1.05, y: '48%' },
  '/icons/cricket-field-ensifera.jpg': { scale: 1.06, y: '48%' },
  '/icons/merian-suriname-butterfly.jpg': { scale: 1.2, y: '44%' },
  '/icons/african-butterfly.jpg': { scale: 1.25, y: '42%' },
  '/icons/barbet.jpg': { scale: 1.35, y: '44%' },
  '/icons/met/544094.jpg': { scale: 1.6, y: '44%' },
  '/icons/lion.jpg': { scale: 1.2, y: '42%' },
  '/icons/elephant-kuhnert-steppe.jpg': { scale: 1.18, y: '46%' },
  '/icons/pool/street-bangkok-kerr.jpg': { scale: 1.22, y: '48%' },
  '/icons/havana-obispo-street.jpg': { scale: 1.12, y: '42%' },
  // Paris sound plates.
  '/icons/paris-accordion-de-smet.jpg': { scale: 1.12, y: '42%' },
  '/icons/paris-cafe-beraud.jpg': { scale: 1.18, y: '48%' },
  '/icons/paris-seine-jongkind.jpg': { scale: 1.2, y: '46%' },
...
export const iconCropBySound: Record<string, IconCrop> = {
  ...
  howler: { scale: 1.2 },
  lion: { scale: 1.2, y: '42%' },
  'global-lion': { scale: 1.2, y: '42%' },
  elephant: { scale: 1.18, y: '46%' },
  'global-elephant': { scale: 1.18, y: '46%' },
  'bangkok-traffic': { scale: 1.22, y: '48%' },
  'havana-cityhum': { scale: 1.12, y: '42%' },
  insects: { scale: 1.08, y: '48%' },
  'summer-cicadas': { scale: 1.1, y: '46%' },
  'sydney-cicadas': { scale: 1.08, y: '50%' },
  'global-insects': { scale: 1.06, y: '48%' },
  'hill-bird': { scale: 1.35, y: '44%' },
