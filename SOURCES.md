...
| [BigSoundBank](https://bigsoundbank.com/) | Wind, forest bed, rain, streams, subway/metro platform (CC0 loops) | CC0 1.0 |
| [Freesound](https://freesound.org/) | Enter-to-globe / enter-soundscape UI whoosh (`public/audio/ui/enter-whoosh.mp3`, ~4.6s with smooth exponential fade-out from susssounds #752068) | CC0 1.0 |
| Saudade (synthesized) | Ethereal globe browse ambient (`public/audio/ui/globe-ambient.mp3`) | Original app asset |
